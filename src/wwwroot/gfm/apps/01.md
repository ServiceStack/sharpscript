...
> YouTube: [youtu.be/2FFRLxs7orU](https://youtu.be/Cf-vstYXrmY)

[![](https://raw.githubusercontent.com/ServiceStack/docs/master/docs/images/app/spirals/animated.png)](https://youtu.be/Cf-vstYXrmY)

You can run this Gist Desktop App via URL Scheme from (Windows Desktop App):

<strong><a name="app://spirals">app://spirals</a></strong>
...
Apps can be customized using both the JavaScript-like [#Script language syntax](/docs/syntax) for any "server" HTML generation
