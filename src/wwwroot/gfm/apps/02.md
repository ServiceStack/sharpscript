The [SharpData](https://github.com/NetCoreApps/SharpData) .NET Core project is a generic tool for providing an instant UI around multiple RDBMS's:
...
<strong><p><a name="app://sharpdata?mix=northwind.sharpdata">app://sharpdata?mix=northwind.sharpdata</a></p></strong>
...
As [NetCoreApps/SharpData](https://github.com/NetCoreApps/SharpData) it can also be deployed as a normal stand-alone .NET Core Web App:
...
(defined in [/components/Custom](https://github.com/NetCoreApps/SharpData/tree/master/src/components/Custom)) to be able to quickly drill down & view 
